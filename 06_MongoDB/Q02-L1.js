...
// users 컬렉션에 username이 :"jones'인 문서를 찾아서 출력하세요
// find() 내에 족ㄴㅇㄹ 넣어주면 해당 조건의 문서만 출력된다
db.users.find({unsername:"jones"});


// users 컬렉션에서 username이 "jonoe 또는 "smith"인 문서를 찾아서 출력하세요
// $or 조건검사 : 
db.users.find({$or:[
    {username:"smith"},
    {username:"jones"}
...
// users 컬렉션에서 uerrname이 smith인 문서를 {username:"smith", country:"Canada"});
db.users.update({country})
// 
...
show collections;
// 혅재 사용 중인 데이터베이스와 users 컬렉션의 상태를 출력하세요
// stats() : 상태 보는 메소드
db.stats();
db.users.stats();
