...
INSERT INTO usertbl VALUES('KKH', '김경호', 1971, '전남', '019', '33333333', 182, '2007-7-7');
...
-- 기존 usertbl 삭제
-- usertbl의 기본키인 userID열은 buytbl에 외래 키로 연결되어 있기 때문에 외래 키를 제거한 후에 다시 기본 키를 제거해야 함
ALTER TABLE buytbl DROP FOREIGN KEY buytbl_ibfk_1;

DROP TABLE IF EXISTS usertbl;
CREATE TABLE usertbl(
usesrID CHAR(8) NOT NULL,
name VARCHAR(10) NOT NULL,
birthYear INT NOT NULL,
